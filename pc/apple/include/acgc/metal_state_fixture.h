...
typedef enum AcgcMetalBlendFactor {
    ...
    ACGC_METAL_BLEND_DESTINATION_COLOR = 4,
    ACGC_METAL_BLEND_ONE_MINUS_DESTINATION_COLOR = 5,
    ACGC_METAL_BLEND_SOURCE_COLOR = 6,
    ACGC_METAL_BLEND_ONE_MINUS_SOURCE_COLOR = 7,
    ACGC_METAL_BLEND_DESTINATION_ALPHA = 8,
    ACGC_METAL_BLEND_ONE_MINUS_DESTINATION_ALPHA = 9
} AcgcMetalBlendFactor;

typedef enum AcgcMetalBlendOperation {
    ACGC_METAL_BLEND_ADD = 0,
    ACGC_METAL_BLEND_REVERSE_SUBTRACT = 1
